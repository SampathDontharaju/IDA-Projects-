...
fprintf('no.of students assigned A grade through Equal frequency  binning %d \n',AFreqcount);
fprintf('no.of students assigned B grade through Equal frequency binning %d \n',BFreqcount);
fprintf('no.of students assigned C grade through Equal frequency binning %d \n',CFreqcount);
fprintf('no.of students assigned D grade through Equal frequency binning %d \n',DFreqcount);
fprintf('no.of students assigned F grade through Equal frequency binning %d \n',FFreqcount);
...
export(SortedbyTotal,'xlsfile','solution2.xls');
